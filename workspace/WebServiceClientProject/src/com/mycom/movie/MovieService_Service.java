...
@WebServiceClient(name = "MovieService", targetNamespace = "http://www.mycom.com/movie", wsdlLocation = "MovieService.wsdl")
    ...
    extends Service
{
    ...
    static {
            MOVIESERVICE_WSDL_LOCATION = com.mycom.movie.MovieService_Service.class.getResource("/MovieService.wsdl");
        WebServiceException e = null;
        if (MOVIESERVICE_WSDL_LOCATION == null) {
            e = new WebServiceException("Cannot find 'MovieService.wsdl' wsdl. Place the resource correctly in the classpath.");
        }
